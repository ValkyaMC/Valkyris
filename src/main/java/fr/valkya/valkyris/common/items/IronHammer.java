...
public class IronHammer extends ItemPickaxe {

	protected IronHammer(ToolMaterial p_i45347_1_) {
		super(VItems.ironHammerMat);
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		...
		if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
			p_77624_3_.clear();
			p_77624_3_.add(EnumChatFormatting.WHITE + "Iron Hammer");
