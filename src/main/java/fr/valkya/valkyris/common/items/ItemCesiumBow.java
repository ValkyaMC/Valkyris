...
public class ItemCesiumBow extends Item {
	
	public static final String[] bowPullIconNameArray = new String[] { "pulling_0", "pulling_1", "pulling_2" };
	@SideOnly(Side.CLIENT)
	private IIcon[] iconArray;

	public ItemCesiumBow()
    {
        this.maxStackSize = 1;
        this.setMaxDamage(500);
        this.setCreativeTab(CreativeTabs.tabCombat);
        this.setTextureName(References.MODID + ":cesium_bow");
    }
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_) {
		...
		if (flag || p_77615_3_.inventory.hasItem(VItems.cesiumArrow)) {
			...
			if (flag) {
				...
				p_77615_3_.inventory.consumeInventoryItem(VItems.cesiumArrow);
			}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
		...
		if (p_77659_3_.capabilities.isCreativeMode || p_77659_3_.inventory.hasItem(Items.arrow) || p_77659_3_.inventory.hasItem(VItems.cesiumArrow)) {
