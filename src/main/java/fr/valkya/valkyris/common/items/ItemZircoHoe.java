...
public class ItemZircoHoe extends ItemHoe {

	public ItemZircoHoe(ToolMaterial p_i45343_1_) {
		super(p_i45343_1_);
	}
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		...
		if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
			p_77624_3_.clear();
			p_77624_3_.add(EnumChatFormatting.WHITE + "Zirconium Hoe");
			p_77624_3_.add("Utilisable en 5x5");
		}
