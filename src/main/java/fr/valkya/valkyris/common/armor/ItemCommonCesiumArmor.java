...
public class ItemCommonCesiumArmor extends ItemArmor {

	public ItemCommonCesiumArmor(ArmorMaterial mat, int type, String name, String texture) {
		super(mat, 0, type);
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		...
		if (armorType == 2) {
			return References.MODID + ":textures/models/armor/cesium_layer_2.png";
		} else {
			return References.MODID + ":textures/models/armor/cesium_layer_1.png";
		}
	}
	...
	public ItemCommonCesiumArmor register() {
