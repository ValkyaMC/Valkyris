...
public class ItemCommonZircoArmor extends ItemArmor {
	
	public ItemCommonZircoArmor(ArmorMaterial mat, int type, String name, String texture) {
		super(mat, 0, type);
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		...
		if (armorType == 2) {
			return References.MODID + ":textures/models/armor/zirco_layer_2.png";
		} else {
			return References.MODID + ":textures/models/armor/zirco_layer_1.png";
		}
	}
	...
	public ItemCommonZircoArmor register() {
