...
import fr.valkya.valkyris.client.models.armor.ModelZirconiumArmor;
...
public class ItemClientZircoArmor extends ItemCommonZircoArmor {
	
	public ItemClientZircoArmor(ArmorMaterial mat, int type, String name, String texture) {
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) {
		if (model == null) {
			if (armorType == 0)
				model = new ModelZirconiumArmor(0.9F, true, false, false, false);
			else if (armorType == 1)
				model = new ModelZirconiumArmor(1F, false, true, false, false);
			else if (armorType == 2)
				model = new ModelZirconiumArmor(1F, false, false, true, false);
			else
				model = new ModelZirconiumArmor(1F, false, false, false, true);
