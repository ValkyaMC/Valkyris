...
public class RenderValorionShovel implements IItemRenderer{
	
	public IModelCustom model;
	ResourceLocation texture = new ResourceLocation(References.MODID, "textures/models/tools/valopickaxe.png");
	ResourceLocation obj = new ResourceLocation(References.MODID, "models/tools/valoshovel.obj");
	
	public RenderValorionShovel() {
