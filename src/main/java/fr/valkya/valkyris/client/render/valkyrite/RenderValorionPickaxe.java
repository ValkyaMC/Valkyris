...
public class RenderValorionPickaxe implements IItemRenderer {

	public IModelCustom model;
	ResourceLocation texture = new ResourceLocation(References.MODID, "textures/models/tools/valopickaxe.png");
	ResourceLocation obj = new ResourceLocation(References.MODID, "models/tools/valopickaxe.obj");
	
	public RenderValorionPickaxe() {
