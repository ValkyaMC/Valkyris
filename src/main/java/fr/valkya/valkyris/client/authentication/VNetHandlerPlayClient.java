...
public class VNetHandlerPlayClient extends NetHandlerPlayClient
{
    ...
    public VNetHandlerPlayClient(Minecraft p_i45061_1_, GuiScreen p_i45061_2_, NetworkManager p_i45061_3_)
    {
    ...
    public void onDisconnect(IChatComponent p_147231_1_)
    {
        ...
        if (this.guiScreenServer != null)
        {
            ...
            {
                this.gameController.displayGuiScreen(new GuiDisconnectedValkya(this.guiScreenServer, "disconnect.lost", p_147231_1_));
            }
        }
        else
        {
            this.gameController.displayGuiScreen(new GuiDisconnectedValkya(new GuiMultiplayer(new GuiNewMainMenu()), "disconnect.lost", p_147231_1_));
        }
    }
    ...
    public void handleUpdateSign(S33PacketUpdateSign p_147248_1_)
    {
        ...
        {
        	// why the fuck should this be sent to the chat??????
            logger.warn("Unable to locate sign at " + p_147248_1_.func_149346_c() + ", " + p_147248_1_.func_149345_d() + ", " + p_147248_1_.func_149344_e());
        }
    }
        ...
        else if ("MC|RPack".equals(p_147240_1_.func_149169_c()))
        {
            ...
            else if (this.gameController.func_147104_D() == null || this.gameController.func_147104_D().func_152586_b() == ServerData.ServerResourceMode.PROMPT)
            {
                this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                {
                    ...
                    {
                        VNetHandlerPlayClient.this.gameController = Minecraft.getMinecraft();

                        if (VNetHandlerPlayClient.this.gameController.func_147104_D() != null)
                        {
                        	VNetHandlerPlayClient.this.gameController.func_147104_D().func_152584_a(ServerData.ServerResourceMode.ENABLED);
                            ServerList.func_147414_b(VNetHandlerPlayClient.this.gameController.func_147104_D());
                        }

                        if (p_73878_1_)
                        {
                        	VNetHandlerPlayClient.this.gameController.getResourcePackRepository().func_148526_a(s);
                        }

                        VNetHandlerPlayClient.this.gameController.displayGuiScreen((GuiScreen)null);
                    }
