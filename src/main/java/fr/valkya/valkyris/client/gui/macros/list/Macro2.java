...
public class Macro2 extends GuiNormalizedScreen {
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        switch (p_146284_1_.id) {
            ...
            case 7:
        		...
        		break;
            case 1:
            	ClientConfig.activem2 = false;
            	ClientConfig.save();
            	this.mc.displayGuiScreen(new Macro2());
            	break;
            case 2:
            	ClientConfig.activem2 = true;
            	ClientConfig.save();
            	this.mc.displayGuiScreen(new Macro2());
        		break;
        }
...
//        		GuiInventory.func_147046_a(k, l, 75, (float)(k) - p_73863_1_, (float)(l - 50) - sr.getScaledHeight() / 2, this.mc.thePlayer); //player
                ...
                this.drawString(fontRendererObj, EnumChatFormatting.GOLD + "Configuration de : " + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + "Macro 2", this.width / 2 - fontRendererObj.getStringWidth("Confuguration de : " + "Macro 2") / 2, this.height / 2 - 100, -1);
