...
public class ConfigSelector extends GuiNormalizedScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new CAnimatedButton(0, this.width / 2 - 175, this.height / 2 - 100, 100, 20, "Options Macros", false));
        this.buttonList.add(new CAnimatedButton(1, this.width / 2 + 175 - 100, this.height / 2 - 100, 100, 20, "Options Armures 3D", true));
