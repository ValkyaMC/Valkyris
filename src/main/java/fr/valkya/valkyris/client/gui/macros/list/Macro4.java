...
public class Macro4 extends GuiNormalizedScreen {
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        switch (p_146284_1_.id) {
            ...
            case 7:
        		...
        		break;
            case 1:
            	ClientConfig.activem4 = false;
            	ClientConfig.save();
            	this.mc.displayGuiScreen(new Macro4());
            	break;
            case 2:
            	ClientConfig.activem4 = true;
            	ClientConfig.save();
            	this.mc.displayGuiScreen(new Macro4());
        		break;
        }
...
//        		GuiInventory.func_147046_a(k, l, 75, (float)(k) - p_73863_1_, (float)(l - 50) - sr.getScaledHeight() / 2, this.mc.thePlayer); //player
                ...
                this.drawString(fontRendererObj, EnumChatFormatting.GOLD + "Configuration de : " + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + "Macro 4", this.width / 2 - fontRendererObj.getStringWidth("Confuguration de : " + "Macro 4") / 2, this.height / 2 - 100, -1);
				...
				this.drawString(fontRendererObj, EnumChatFormatting.GOLD + "Commande actuelle : " + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + ClientConfig.macro4, this.width / 2 - fontRendererObj.getStringWidth("Commande actuelle : " + ClientConfig.macro4) / 2, this.height / 2 - 70, -1);
