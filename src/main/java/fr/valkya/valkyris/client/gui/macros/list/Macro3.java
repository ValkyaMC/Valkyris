...
public class Macro3 extends GuiNormalizedScreen {
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        switch (p_146284_1_.id) {
            ...
            case 7:
        		...
        		break;
            case 1:
            	ClientConfig.activem3 = false;
            	ClientConfig.save();
            	this.mc.displayGuiScreen(new Macro3());
            	break;
            case 2:
            	ClientConfig.activem3 = true;
            	ClientConfig.save();
            	this.mc.displayGuiScreen(new Macro3());
        		break;
        }
...
//        		GuiInventory.func_147046_a(k, l, 75, (float)(k) - p_73863_1_, (float)(l - 50) - sr.getScaledHeight() / 2, this.mc.thePlayer); //player
                ...
                this.drawString(fontRendererObj, EnumChatFormatting.GOLD + "Configuration de : " + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + "Macro 3", this.width / 2 - fontRendererObj.getStringWidth("Confuguration de : " + "Macro 3") / 2, this.height / 2 - 100, -1);
				...
				this.drawString(fontRendererObj, EnumChatFormatting.GOLD + "Commande actuelle : " + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + ClientConfig.macro2, this.width / 2 - fontRendererObj.getStringWidth("Commande actuelle : " + ClientConfig.macro2) / 2, this.height / 2 - 70, -1);
