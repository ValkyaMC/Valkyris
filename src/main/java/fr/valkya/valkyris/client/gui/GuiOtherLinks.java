...
public class GuiOtherLinks extends GuiNormalizedScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new CAnimatedButton(0, this.width / 2 - 175, this.height / 2 - 100, 100, 20, "Discord", false));
        this.buttonList.add(new CAnimatedButton(1, this.width / 2 + 175 - 100, this.height / 2 - 100, 100, 20, "Wiki", true));
        this.buttonList.add(new CAnimatedButton(3, this.width / 2 - 175, this.height /2 - 50, 100, 20, "Vote", false));
        this.buttonList.add(new CAnimatedButton(2, this.width / 2 + 175 - 100, this.height / 2 - 50, 100, 20, "Boutique", true));
        this.buttonList.add(new CAnimatedButton(4, this.width / 2 - 175, this.height / 2, 100, 20, "Forum", false) {
        	private TimeHelper timer = new TimeHelper();
        	@Override
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        switch (p_146284_1_.id) {
	        case 0:
				try {
					Desktop.getDesktop().browse(new URI("https://discord.valkya.fr/"));
				} catch (Exception e) {
					e.printStackTrace();
				}
				break;
	        case 1:
	        	try {
					Desktop.getDesktop().browse(new URI("https://valkya.fr/wiki"));
				} catch (Exception e) {
					e.printStackTrace();
				}
	        case 2:
	        	try {
					Desktop.getDesktop().browse(new URI("https://valkya.fr/shop"));
				} catch (Exception e) {
					e.printStackTrace();
				}
	        case 3:
				try {
					Desktop.getDesktop().browse(new URI("https://valkya.fr/vote"));
				} catch (Exception e) {
					e.printStackTrace();
				}
				break;
        	case 4:
        		try {
					Desktop.getDesktop().browse(new URI("https://valkya.fr/forum"));
				} catch (Exception e) {
					e.printStackTrace();
				}
                break;
            ...
            case 6:
        		...
        		break;
            case 7:
        		this.mc.displayGuiScreen(new GuiIngameMenuValorion());
        		break;
        }
    }
